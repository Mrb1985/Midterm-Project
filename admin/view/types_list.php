...
<?php if (!empty($types)) : ?> 
    <section id="list" class="list">
        <header>
            <h1 style ="text-align:center;font-size: 40px;">Type List</h1>
        </header>
        ...
        <?php foreach ($types as $type) : ?>
            <div class="list__row">
                <div class="list__item">
                    ...
                    <p style ="text-align:center;font-size: 20px;" class="bold"><?= htmlspecialchars($type['typeName']) ?>
                    <b> Type ID = </b>
                    <?= htmlspecialchars($type['typeID']) ?> 
                </p>
                </div>
...
<section>
    <h2 style ="text-align:center;font-size: 40px;">Add type</h2>
